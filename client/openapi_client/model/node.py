...
class Node(ModelNormal):
    ...
    validations = {
        ('node_id',): {
            'regex': {
                'pattern': r'^((urn:sdx:node:)[A-Za-z_.-]*$)',  # noqa: E501
            },
        },
        ('name',): {
            'max_length': 30,
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, node_id, name, location, ports, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, node_id, name, location, ports, *args, **kwargs):  # noqa: E501
        """Node - a model defined in OpenAPI
